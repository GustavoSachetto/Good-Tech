...
class Examiner
{
    ...
    */
    ...
    {
        if (empty($itens)) throw new Exception('Array está vazio', 404);
    }
    ...
    */
    ...
    {
        if (!$object instanceof $instance) throw new Exception('Objeto não existente', 404);
    }
    ...
    */
    ...
    {
        if ($object instanceof $instance) throw new Exception('Objeto já existente', 400);
    }
