...
class Examiner
{
    ...
    */
    ...
    /** 
     * Método responsável por verificar se a senha contém letras e números
    */
    public static function checkPassword(mixed $password): void
    {
        // no mínimo 1 letra e 1 número
        // exemplo: gustavo2
        $pattern = '/(?=.*\d)(?=.*[a-zA-Z])/';

        if (!preg_match($pattern, $password)) throw new Exception("Sua senha não contém letras e números", 400);
    }
