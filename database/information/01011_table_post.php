...
return new class extends Interaction
{
    ...
    private array $informations = [
        ...
        [
            ...
            'content'     => 'Pessoas portadora de mobilidade reduzida são aqueles indivíduos que por algum motivo aparente apresenta alguma dificuldade de movimentação\r\npermanente ou temporária, como consequência a redução efetiva da mobilidade, flexibilidade, percepção\r\nou coordenação motora acontece.',
